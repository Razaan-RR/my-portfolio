    ...
    <section className="relative py-20 overflow-hidden bg-gradient-to-b from-[#050816] via-[#0B1120] to-[#050816] flex flex-col items-center justify-center px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24">
      ...
      <div className="relative z-10 max-w-7xl w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative flex justify-center">
          {/* Glow */}
          <div className="absolute h-[420px] w-[420px] rounded-full bg-gradient-to-r from-cyan-400/20 via-purple-500/20 to-pink-500/20 blur-3xl"></div>

          <img
            src={vscodeImg}
            alt="VS Code Workspace"
            className="relative w-full max-w-2xl object-contain rounded-xl border border-cyan-500/20 shadow-[0_0_60px_rgba(6,182,212,0.25)] hover:scale-[1.02] transition duration-500"
          />
        </div>
      </div>
