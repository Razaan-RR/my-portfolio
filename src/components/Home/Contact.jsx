...
function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative py-10 flex flex-col items-center justify-center bg-gradient-to-b from-slate-100 via-slate-200 to-slate-100 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 overflow-hidden"
    >
      <motion.div
